...
def restaurantList():
    ...
    if 'username' in login_session:
        ...
        return render_template('restaurantlist.html', restaurants=restaurants, user=user)
    return render_template('publicrestaurantlist.html', restaurants=restaurants)
...
#Restaurant specific page with editing restaurant, adding menu item, editing menu item, adding images
...
def restaurantMenu(restaurant_id):
    ...
    if 'user_id' in login_session:
        ...
        return render_template('publicrestaurantmenu.html', restaurant=restaurant, apps=apps, entrees=entrees, desserts=desserts, brunches=brunches, drinks=drinks, sides = sides, appscount=appscount, entreescount=entreescount, dessertscount=dessertscount, brunchescount=brunchescount, drinkscount = drinkscount, sidescount = sidescount) 
...
# Upload/Modify a logo image for the landing page and save to restaurant img folder
...
# Upload/Modify an interior photo for restaurant page and save to restaurant img folder
