...
restaurant1 = Restaurant(user_id=1, name="Hawthornes Biercafe", logo='https://drive.google.com/open?id=0B0AV8BnWCTfzOXJrR05tMFdrR1U', interior='https://drive.google.com/open?id=0B0AV8BnWCTfzOTZjTDMzWHNCbDQ', link='http://www.hawthornecafe.com/', neighborhood='Bella Vista', street='738 S. 11th Street', city='Philadelphia', state='PA', zipcode='19147', foodtype='American')
...
restaurant2 = Restaurant(user_id=1, name='Miles Table', logo='https://drive.google.com/open?id=0B0AV8BnWCTfzZXVLQS1iX0lpWjg', interior='http://cdn-jpg.thedailymeal.net/sites/default/files/user_img_uploads/u45592/rsz_miles_table_2.jpg', link='http://milestable.com/', neighborhood='Graduate Hospital', street='1620 South Street', city='Philadelphia', state='PA', zipcode='19146', foodtype='American')
...
restaurant3 = Restaurant(user_id=1, name='Khyber Pass', logo='https://drive.google.com/open?id=0B0AV8BnWCTfzMF84MFBvazZ0VUE', interior='http://cdn.phillymag.com/wp-content/uploads/2011/10/contents_d5-1024x571.jpg', link='http://www.khyberpasspub.com/', neighborhood='Old City', street='56 S 2nd St', city='Philadelphia', state='PA', zipcode='19106', foodtype='Cajun')
...
restaurant4 = Restaurant(user_id=1, name='The Dandelion Pub', logo='https://drive.google.com/open?id=0B0AV8BnWCTfzc0k3R3luUk81a0U', interior='http://media.philly.com/images/600*450/aerick16-zz.jpg', link='http://thedandelionpub.com/', neighborhood='Rittenhouse', street='124 S 18th St', city='Philadelphia', state='PA', zipcode='19103', foodtype='British')
...
restaurant5 = Restaurant(user_id=1, name='Fat Ham', logo='https://drive.google.com/open?id=0B0AV8BnWCTfzSGJVYmNaMVdMN0k', interior='http://cdn.cstatic.net/images/gridfs/52a23146f92ea1695900a143/fatham7.jpg', link='https://www.sbragadining.com/fatham/', neighborhood='University City', street='3131 Walnut St', city='Philadelphia', state='PA', zipcode='19104', foodtype='Southern')
...
restaurant6 = Restaurant(user_id=1, name='La Viola: Ovest', logo='https://drive.google.com/open?id=0B0AV8BnWCTfzcWVTQjdZeUNES1U', interior='http://laviolaphiladelphia.com/assets/west/events/photo03.png', link='http://laviolaphiladelphia.com/west/', neighborhood='Rittenhouse', street='253 S 16th St', city='Philadelphia', state='PA', zipcode='19102', foodtype='Italian')
...
menuItem23 = MenuItem(user_id=1, name="Vitello Rollatini", description="veal medallions stuffed with spinach, smoked ham and fontina cheese in a rosee sauce with mushrooms and chopped tomatoes",
...
restaurant7 = Restaurant(user_id=1, name='Amada', logo='http://philadelphia.amadarestaurant.com/a/i/logo-print.png', interior='http://philadelphia.amadarestaurant.com/m/widgets/PDR1436x650.jpg', link='http://philadelphia.amadarestaurant.com/', neighborhood='Old City', street='217 Chestnut St', city='Philadelphia', state='PA', zipcode='19106', foodtype='Spanish')
...
restaurant8 = Restaurant(user_id=1, name='My Thai', logo='https://drive.google.com/open?id=0B0AV8BnWCTfzMHpkb0pjaVl0aFk', interior='http://s3-media1.fl.yelpcdn.com/bphoto/izdQFg675LeOPj0-fVHaMA/o.jpg', link='', neighborhood='Graduate Hospital', street='2200 South St', city='Philadelphia', state='PA', zipcode='19146', foodtype='Thai')

session.add(restaurant8)
session.commit()

menuItem29 = MenuItem(user_id=1, name="Tom Kha Gai", description="chicken coconut soup. chicken soup in coconut milk with lemongrass, galanka, lime leaves, bell peppers and scallions",
...
restaurant9 = Restaurant(user_id=1, name='El Rey', logo='https://drive.google.com/open?id=0B0AV8BnWCTfzNUpBSlJ4eWRhWkU', interior='http://media.philly.com/images/20100422_inq_table22z-b.JPG', link='http://www.elreyrestaurant.com/', neighborhood='Rittenhouse', street='2013 Chestnut St', city='Philadelphia', state='PA', zipcode='19103', foodtype='Mexican')

session.add(restaurant9)
session.commit()

menuItem29 = MenuItem(user_id=1, name="Sopa De Hongos", description="wild mushroom soup",
                     price="$5.50", course="Appetizer", restaurant=restaurant9)

session.add(menuItem29)
session.commit()

menuItem30 = MenuItem(user_id=1, name="Camarones", description="shrimp, fried garlic, squeeze of lime",
                     price="$15.50", course="Entree", restaurant=restaurant9)

session.add(menuItem30)
session.commit()

menuItem31 = MenuItem(user_id=1, name="Zarape", description="steak and fried potatoes between 2 crispy tortillas smothered in arbol salsa topped with pasilla peppers , fried duck egg, and crema",
                     price="$13.00", course="Entree", restaurant=restaurant9)

session.add(menuItem31)
session.commit()

menuItem32 = MenuItem(user_id=1, name="Campachi Ceviche", description="campachi, radish, apple, tomato, jalapeno with orange and avocado topped with fried jicama & red onion",
                     price="$12.00", course="Entree", restaurant=restaurant9)

session.add(menuItem32)
session.commit()

restaurant10 = Restaurant(user_id=1, name='Tio Flores', logo='https://drive.google.com/open?id=0B0AV8BnWCTfzQUhYaFdheEc3ZDA', interior='https://pbs.twimg.com/media/CTZExiRWEAEhhgx.png', link='http://www.tioflores.com/', neighborhood='Graduate Hospital', street='1600 South St', city='Philadelphia', state='PA', zipcode='19146', foodtype='Mexican')

session.add(restaurant10)
session.commit()

menuItem29 = MenuItem(user_id=1, name="Lentil & Cauliflower Tacos [2]", description="lentils, roasted cauliflower, queso fresco, warmed pico de gallo, lime crema ",
                     price="$10.00", course="Appetizer", restaurant=restaurant10)

session.add(menuItem29)
session.commit()

menuItem30 = MenuItem(user_id=1, name="Tequila Chipotle Shrimp Tacos [2]", description="avocado, jicama slaw, lime crema",
                     price="$10.00", course="Entree", restaurant=restaurant10)

session.add(menuItem30)
session.commit()

menuItem31 = MenuItem(user_id=1, name="Beer Battered Tilapia Tacos [2]", description="jicama slaw, lime crema",
                     price="$15.00", course="Entree", restaurant=restaurant10)

session.add(menuItem31)
session.commit()

menuItem32 = MenuItem(user_id=1, name="Gringa Tacos [2]", description="chicken tinga, avocado, queso fresco, lime crema, lettuce, chili de arbol ",
                     price="$10.00", course="Entree", restaurant=restaurant10)
